...
\begin{enumerate}[label={[G\arabic*]},labelindent=\parindent,leftmargin=*]
	\item \itemtext{goal:registration}{Registration of a user to the system}
	\item \itemtext{goal:cars_location}{Finding the locations of the available cars}
	\item \itemtext{goal:reservation}{Reservation of a car}
	\item \itemtext{goal:expiration}{Expiration of reservation and penalization}
	\item \itemtext{goal:entry}{Entry of registered user into the car}
	\item \itemtext{goal:charging}{Start charging and notifying the registered user}
	\item \itemtext{goal:car_locking}{Stop charging the registered user and lock the car}
	\item \itemtext{goal:safe_areas}{Safe areas for parking the reserved cars}
	\item \itemtext{goal:passengers}{Detection of extra passengers and applying discount}
	\item \itemtext{goal:battery}{Detection of the battery status and applying discount}
	\item \itemtext{goal:special_areas}{Detection of special parking areas and applying discount}
	\item \itemtext{goal:constraints}{Checking parking and battery constraints and penalization}
\end{enumerate}
...
\begin{itemize}
	...
	\item The licence office provides the online service to let the system instantly check the user's documents during the registration.
