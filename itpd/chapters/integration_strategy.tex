...
\paragraph{Application server.} It includes all the business logic and provides web services so that users can interact with this layer from both the interfaces. The components to be integrated are:
\begin{itemize}
	\item Map Manager
